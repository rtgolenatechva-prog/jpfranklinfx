...
export const PRICING_TIERS: PricingTier[] = [
  {
    id: 'launch',
    name: 'Launch',
    tagline: 'Your first AI agent system',
    price: 3000,
    description:
      'For growing businesses deploying their first autonomous AI agent system. Prove the ROI before scaling.',
    features: [
      '1 fully custom agent system (your choice of 6)',
      'Integration with up to 5 tools/APIs',
  ...
  },
  {
    id: 'scale',
    name: 'Scale',
    tagline: 'Multiple systems, coordinated',
    price: 6000,
    description:
      'For businesses ready to automate multiple revenue-critical workflows simultaneously. Our most popular tier.',
    features: [
      '3 custom agent systems (coordinated)',
  ...
  },
  {
    ...
    price: 10000,
    description:
      'For enterprises deploying AI as a core business infrastructure layer. Dedicated team, SLA-backed, board-level visibility.',
    features: [
      'Full AI Suite deployment (all 6 systems)',
      'Custom model fine-tuning',
      '14-day deployment timeline',
      'Dedicated AI engineer (yours)',
      '24/7 monitoring + SLA guarantee',
      'Board-level reporting',
      'Annual AI roadmap planning',
      'Full source code ownership',
    ],
